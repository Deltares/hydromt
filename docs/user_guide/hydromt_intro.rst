...
HydroMT is designed to be modular and extensible, and it is built around a plugin architecture.
...
- **Input Data**
  ...
  Currently, five different types of input data are supported and represented by a specific Python data
