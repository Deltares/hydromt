...
grid model (distributed model), lumped model (e.g. semi-distributed, bucket models), mesh model (e.g. unstructured models) have been implemented. Other model classes will follow in future versions.
...
.. list-table::
   ...
   * - maps
     - Auxiliary data maps
     - :py:attr:`~Model.auxmaps`
       :py:func:`~Model.set_auxmaps`
       :py:func:`~Model.read_auxmaps`
       :py:func:`~Model.write_auxmaps`
   * - geoms
     - Static vector data
     - :py:attr:`~Model.geoms`
...
.. list-table::
   ...
   * - response_units
     - Static vector data of the computational units
     - Lumped model
