...
def test_deep_merge_simple():
    ...
    assert _deep_merge(left, right) == {"a": 1, "b": 24, "c": 4, "d": 1, "e": 4}
...
def test_deep_merge_nested_overwrite():
    ...
    assert _deep_merge(left, right) == {"a": 1, "b": 2, "c": {"d": {"b": {"e": 8}}}}
...
def test_deep_merge_override_dict_with_value():
    ...
    assert _deep_merge(left, right) == {"a": 3}
