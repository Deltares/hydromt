...
from hydromt.models.v1.grid import GridModelComponent


def test_set_GridModelComponent(hydds, tmp_dir, rioda):
    gridmodel_component = GridModelComponent(root=tmp_dir)
